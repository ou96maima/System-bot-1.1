...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('degree-type').setDescription('Select what degree type you would like.').addChoices(
            ...
            setTimeout(() => {
                if(err){
                    ...
                    if(result.length == 0){
                        ...
                        const alert = result[0].current.alert || 'None';
