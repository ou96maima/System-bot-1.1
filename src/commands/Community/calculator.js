...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('calculator')
        .setDescription('Use a calculator.'),
        ...
        collector.on('collect', async i => {
            ...
            if(value === '='){
                try {
                    ...
                    data = '';
                    extra = `An Error Occured, please click on the AC for a restart.`
                }
            } else if(value === 'clear'){
                data = '';
                ...
                data += `${((parseInt(value) == value || value === '.') && (lc == parseInt(lc) || lc === '.')) || data.length === 0 ? '' : ' '}` + value;
            }
